...
class GetCoords:
    ...
    .. note:: The Cartesian XYZ coordinates can be read either from RESULTS/dyn.out
              or from RESULTS/dyn.xyz file. Repeated geometries will be skipped.
    ...
    def build_dataframe(self):
        """Creates a pandas DataFrame containing all XYZ coordinates."""
    ...
    @staticmethod
    def from_h5(outfile):
        """Reads the XYZ coordinates from the .h5 file generated by the new Newton-X.
