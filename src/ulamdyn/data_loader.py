...
class GetCoords:
    ...
    .. note:: In the case of NX classical series, the Cartesian XYZ coordinates can be
              read either from dyn.out or dyn.xyz. For NX new series, the data will be
              taken from the h5 file of each trajectory. Repeated geometries will be
              skipped.
    ...
    @staticmethod
    def from_h5(outfile) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
